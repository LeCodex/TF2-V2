...
item entity @s[scores={tf.disguiseTmr=40},team=tf.blu] armor.feet replace leather_boots{display:{color:11546150},AttributeModifiers:[]}
item entity @s[scores={tf.disguiseTmr=40},team=tf.red] armor.feet replace leather_boots{display:{color:3847130},AttributeModifiers:[]}
