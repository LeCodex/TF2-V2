...
item replace entity @s[scores={tf.disguise=9},team=tf.red] armor.feet with leather_boots{display:{color:3847130},AttributeModifiers:[]}
item replace entity @s[scores={tf.disguise=9},team=tf.blu] armor.feet with leather_boots{display:{color:11546150},AttributeModifiers:[]}
