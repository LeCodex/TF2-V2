...
clear @s
give @s carrot_on_a_stick{tfTags:{flags:["tf.projectile","tf.weapon", "tf.clipReload"],clip:20,clipSize:20,ammo:150,maxAmmo:150,reload:{first:32,consecutive:32},cooldown:4,damage:20}}
